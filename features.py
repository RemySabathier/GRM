...
class Regions():
    ...
    def __init__(self, segmentation_image, image):
        ...
        self.is_contiguous = self.contiguous_regions()
    ...
    def contiguous_regions(self):
        ...
        for region in self.region_props:
            label = region.label
            if label in is_contiguous.keys():
                is_contiguous[label] = 1
            else:
                is_contiguous[label] = 0
    ...
    def compute_features(self):
        ...
        for region in self.region_props:
            ...
            # L5. Number of sides of convex hull
            hull = region["convex_image"]
            contours = measure.find_contours(hull, 0.8)
            L5 = len(contours)
